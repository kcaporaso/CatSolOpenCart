...
<div class="box">
  ...
  <div class="middle">
   <div id="module_search">
       <?php if ($keyword) { ?>
       	<input type="text" name="keyword" size="21" value="<?php echo $keyword; ?>" id="filter_keyword" />
       <?php } else { ?>
       	<input type="text" name="keyword" size="21" value="<?php echo $text_keywords; ?>" id="filter_keyword" onclick="this.value = ''" />
       <?php } ?>

            <a style="position:relative;float:right;" onclick="moduleSearch();" class="button-red">
