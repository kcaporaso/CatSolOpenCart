...
<?php } ?>
   <div id="module_search">
       <?php if ($keyword) { ?>
       	<input type="text" name="keyword" size="10" value="<?php echo $keyword; ?>" id="filter_keyword" />
         <?php if ($_SESSION['store_code'] == 'KBC') { ?>
         ...
         <?php } ?>
       <?php } else { ?>
       	<input type="text" name="keyword" size="10" value="<?php echo $text_keywords; ?>" id="filter_keyword" onclick="this.value = ''" />
         <?php if ($_SESSION['store_code'] == 'KBC') { ?>
