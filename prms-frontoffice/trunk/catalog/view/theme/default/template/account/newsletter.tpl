  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="newsletter">
    <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 10px;">
      <table>
      	<tr>
      	  <td colspan="9">
Click to subscribe to our newsletter and you will receive
special offers and coupons. Please be assured we will not sell or
give away your personal information in any way.
			<br><br>  
      	  </td>
      	</tr>
        <tr>
