...
<div class="middle">
  ...
  <?php } ?>
  <div id="account_new_customer"><b style="margin-bottom: 3px; display: block;"><?php echo $text_i_am_new_customer; ?></b>
    <div class="account_box"><?php echo $text_new_customer; ?><br />
      <br />
  ...
  <div id="account_returning_customer"><b style="margin-bottom: 3px; display: block;"><?php echo $text_returning_customer; ?></b>
