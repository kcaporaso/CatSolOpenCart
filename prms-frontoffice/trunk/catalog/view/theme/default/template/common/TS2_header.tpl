<div class="div1">
  <div class="div2">
    ...
    <?php if (!$logged) { ?>
      <img border="0" usemap="#logo" src="catalog/view/theme/default/image/TS2_login.png" title="Navigation" alt="Navigation" />
    <?php } else { ?>
      <img border="0" usemap="#logo" src="catalog/view/theme/default/image/TS2_logout.png" title="Navigation" alt="Navigation" />
    <?php } ?>
