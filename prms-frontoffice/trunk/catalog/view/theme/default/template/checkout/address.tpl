  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="address_1">
    ...
    <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 10px;">
      <table width="100%">
        ...
        <?php if ($address['address_id'] == $default && $address['type'] != 'billing') { ?>
        <tr>
        ...
        <tr>
          ...
          ?>
            <td width="1"><input type="radio" name="billing_address_id" value="<?php echo $address['address_id']; ?>" id="billing_address_id[<?php echo $address['address_id']; ?>]" /></td>
            <td><label for="billing_address_id[<?php echo $address['address_id']; ?>]"><?php echo $address['address']; ?></label></td>
          <?php 
          } else {
          ?>
