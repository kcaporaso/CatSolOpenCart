...
<div class="middle">
  <img src="catalog/view/theme/default/image/Payment2.png" border="0"/>
  <hr style="width:100%"/>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="payment">
    ...
    <div class="fieldset">
      <div style="width: 45%; margin-right:5%; display: inline-block; float: left;"><?php echo $text_payment_to; ?><br />
        <br />
    ...
    <div class="buttons">
      <table>
        <tr>
          <td align="left"><a onclick="location='<?php echo $back; ?>'" class="button"><span><?php echo $button_back; ?></span></a></td>
          <td align="right"><a onclick="$('#payment').submit();" class="button-red"><span><?php echo $button_continue; ?></span></a></td>
        </tr>
      </table>
    </div>
    <?php } ?>
