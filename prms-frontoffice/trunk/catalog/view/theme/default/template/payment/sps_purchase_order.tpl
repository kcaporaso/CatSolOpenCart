...
<form action="<?php echo $action; ?>" method="post" id="checkout">
  ...
  <input type="text" name="purchase_order_number" value="<?php echo $purchase_order_number; ?>" size="30"/><br/>
  ...
  <input type="text" name="purchase_order_accountnumber" value="<?php echo $purchase_order_accountnumber; ?>" size="30"/>
  </div>
</form>
<div class="buttons">
  <table>
