...
#category {
   /*background-image: url('../image/TTB_category_background.png');
...
#information {
   ...
   background-image:url('../image/TTB_information_background.png');
   background-repeat: no-repeat;
}
...
#mfg {
   background-color:#fff7b3;
   background-image:url('../image/TTB_mfg_background.png');
   background-repeat: no-repeat;
   min-height:40px;
}
#bestseller {
   background-color:#fff7b3;
   background-image:url('../image/TTB_bestseller_background.png');
   background-repeat: no-repeat;
...
#calendar {
   background-color:#fff7b3;
   background-image:url('../image/TTB_calendar_background.png');
   background-repeat: no-repeat;
   min-height:210px;
}
.cart {
