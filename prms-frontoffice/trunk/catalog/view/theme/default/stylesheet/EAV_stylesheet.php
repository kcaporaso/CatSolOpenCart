...
body {
	background:#fff url(../image/EAV_background.png) center center repeat;
	margin: 0px;
	padding: 0px;
	text-align: center;
}
...
#module_cart{color:#fff; text-align:center; font-size:1.5em;}
#module_cart a{color:#fff; text-decoration:none; font-size:12px; font-weight:bold;}
#breadcrumb {
	padding-top: 8px;
	padding-bottom: 10px;
	padding-left: 10px;
...
#breadcrumb a{color:#A05CDF; text-decoration:none;}
#column_left {
	float: left;
	width: 223px;
	margin-left: 3px;
...
#module_search{
	...
	padding-top:1px;
	height:103px;
	background:url(../image/EAV_bgSearch.png) top left no-repeat;
	position:relative;
}
...
#button_powersearch span{visibility:hidden;}
...
#category{
	background:url(../image/EAV_bgCategories.png) bottom left no-repeat;
}
#category a{text-decoration:none;font-weight:bold; color:#000;}
#information ul {
	margin-top: 0px;
	margin-bottom: 0px;
	margin-left: 8px;
