...
.kbc-cart a{font-size:13px; color:#006BB7; text-decoration:none;}
.kbc-cart a span{visiblity:hidden;}
html {
...
#category{background:url('../image/ATS_icon_category_bot.png') left bottom no-repeat;}
