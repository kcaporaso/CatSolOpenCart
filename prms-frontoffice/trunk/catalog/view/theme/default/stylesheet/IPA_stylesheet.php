...
#content .top {
   ...
   border-left:2px solid #7bd1eb;
   border-right:2px solid #7bd1eb;
   border-top:2px solid #7bd1eb;
...
.heading {
   height:89px;
	...
	padding-bottom: 3px;
	margin-bottom: 10px;
   background-image: url('../image/IPA_heading.png');
...
#content .bottom {
   ...
   border-left:2px solid #7bd1eb;
   border-right:2px solid #7bd1eb;
   border-bottom:2px solid #7bd1eb;
...
#search {
   background-image:url('../image/IPA_icon_search.jpg'); background-position:left; background-repeat:no-repeat;
   background-color: #bcce7e;
   padding: 10px;
   margin: 0;
   border:2px solid #7bd1eb;
...
.subcategory_list{border:solid #7BD1EB; border-width:0 2px 2px 2px;}
