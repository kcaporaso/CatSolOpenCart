...
body {
	...
	padding: 0px;
	text-align: center;
   background-image:url('../image/BCR_background.png');
}
...
#content .top {
   ...
   border-top:2px solid #5E7CA6 ;
   border-left:2px solid #5E7CA6 ;
   border-right:2px solid #5E7CA6 ;
...
.box-cart .middle img { position:relative; float:right; }
.box-cart .middle h3 { font-size:14px; color:#5E7CA6; }
.box-cart .middle {
	border: 2px solid #5E7CA6;
	background: #FFFFFF;
	padding-left: 4px;
	padding-right: 4px;
   height:87px;
