...
body {
	...
	padding: 0px;
	text-align: center;
	background:#F5FBFF url(../image/ALS_bgSite.png) top center repeat-x;
}
...
#module_cart{width:303px; height:105px; padding-top:50px; position:absolute; top:23px; right:10px;}
#module_cart p{text-align:center; font-size:16px; color:#8DD7F7; font-weight:bold; margin:25px auto 0;}
#module_cart a{text-decoration:none; color:#8DD7F7; font-size:16px;}
...
#category ul {
	...
	margin-left: 8px;
	padding-left: 12px;
	list-style: disc; /*url('../image/bullet_1.png');*/
	font-size:15px;
	font-family:helvetica, sans-serif;
}
#category{
	background:url(../image/ALS_category_bot.png) bottom left no-repeat;
}
#category a{
	text-decoration:none;
	font-size:14px;
...
#information ul {
	...
	font-size:15px;
	fot-family:helvetica, san-serif;
}
#information a{
	text-decoration:none;
        font-size:14px;
...
#bestseller_module .top{
	height:58px;
	margin:0;
}
#module_search{
	background:url(../image/ALS_icon_search.png) top left no-repeat;
	width:200px;
	height:143px;
	position:relative;
	margin-top:0;
...
#search_advanced span{display:none;}
#module_mfg{
	position:relative;
	z-index:10;
	padding:0;
