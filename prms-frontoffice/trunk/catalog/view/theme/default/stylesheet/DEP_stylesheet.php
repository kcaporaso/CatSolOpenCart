...
#header .div2-logo {
   background:url('../image/DEP_background.jpg') repeat-x;
   position: relative;
   top: 15px;
   left: 0px;
   height:125px;
...
.box .middle {
	/*background: #8AD043;*/
   background:url('../image/DEP_column.png') repeat-y;
	padding: 10px;
}
.box .bottom {
	height: 5px;
...
.div4 .div5 #menu {
   ...
   padding: 0;
   width: 100%;
   background-image:url('../image/DEP_menu_nav.png');
...
.div4 .div5 #menu a:hover {
   color: #ccc;
   padding-bottom: 8px;
}
   
.div4 .div5 #menu li a.current{ color:#F00;}
