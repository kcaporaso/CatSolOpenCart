...
/* Custom EDM Code for Demo */
#module_cart {
   position:relative;
   height:167px;
	background: url('<?php echo HTTPS_IMAGE .'stores/'.$store_code ?>/cart_bg.jpg') no-repeat;
}
...
body {
	...
	padding: 0px;
	text-align: center;
   background: url('../image/EDMbg.gif');
}
...
#header .div4 {
	...
	padding-right: 10px;
	height: 30px;
	/*background: url('<?php echo HTTP_IMAGE .'stores/'.$store_code ?>/nav_background.png') repeat-x;*/
}
#header .div4 img {
	float: left;
	margin-right: 5px;
...
a.button {
	background: transparent url('../image/button_right_edmat.png') no-repeat scroll top right;
	color: #FFFFFF;
	display: inline-block;
	font: normal 12px arial, sans-serif;
	height: 25px;
...
a.button span {
	background: transparent url('../image/button_left_edmat.png') no-repeat;
	display: inline-block;
	padding: 5px 0 5px 18px;
}
