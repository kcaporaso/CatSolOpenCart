...
#module_search{border:1px solid #C4DFBD; background:#EDF4DE;margin:0;padding:3px;}
#category{border:1px solid #3878BD;background:#F2F2AB url(../image/TPM_bg_category.png) left top repeat-x;}
#category a{text-decoration:none;}
#category li{padding-bottom:3px;}
#category .middle{background:none;}
.kbc-cart {color:#54A245;font-size:14px;}
