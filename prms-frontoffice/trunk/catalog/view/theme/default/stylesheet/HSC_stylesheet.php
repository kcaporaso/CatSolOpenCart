...
#module_cart div {
	text-align:center; font-family:Verdana, Geneva, sans-serif; font-size:12px; color:#266759; font-weight:bold;
}
#module_cart a{ font-family:Verdana, Geneva, sans-serif; font-size:11px;color:#266759; text-decoration:none;font-weight:normal; }
html {
...
body {
	background:#A42639 url(../image/HSC_bg_site.png) top left repeat;
	margin: 0px;
	padding: 0px;
	text-align: center;
}
...
.box .middle {
	background: #FFFFFF url(../image/HSC_bg_boxes.png) bottom left no-repeat;
	padding: 10px;
}
.box .bottom {
	height: 5px;
}
#calendar{background-image:none;}
.success {
	padding: 5px 0px;
	margin-bottom: 10px;
	background: #E4F1C9;
...
#category a{color:#266759; text-decoration:none;}
#information ul {
	color:#A42639;
	margin-top: 0px;
	margin-bottom: 0px;
...
#information a{color:#266759; text-decoration:none;}
#module_search{text-align:center;}
#module_search input{vertical-align:top;}
#module_search{vertical-align:middle;}
.cart {
	border-collapse: collapse;
	margin-bottom: 10px;
	width: 100%;
