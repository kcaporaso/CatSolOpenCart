...
body {
	...
	padding: 0px;
	text-align: center;
   background: url('../image/FSH_background.png');
}
...
#header .div2-logo .home2 a span { display: none; } 
#header .div2-logo .myaccount a span { display: none; } 
#header .div2-logo .login a span { display: none; } 
#header .div2-logo .sales a span { display: none; } 
#header .div2-logo .workshops a span { display: none; } 
#header .div2-logo .teachers a span { display: none; } 
