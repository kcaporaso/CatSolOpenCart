...
class ControllerAccountForgotten extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			...
			$this->model_account_customer->editPassword($_SESSION['store_code'], $this->request->post['email'], $password);
	...
	private function validate() {
		...
		} elseif (!$this->model_account_customer->getTotalCustomersByEmail($_SESSION['store_code'], $this->request->post['email'])) {
			$this->error['message'] = $this->language->get('error_email');
		}
