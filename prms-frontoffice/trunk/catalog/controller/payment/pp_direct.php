<?php
class ControllerPaymentPPDirect extends Controller {
	...
	public function send() {
		...
		if ($response_data['ACK'] == 'Success') {
			...
			$this->model_checkout_order->update($_SESSION['store_code'], $this->session->data['order_id'], $this->config->get('pp_direct_order_status_id'), $message, FALSE);
