	...
	public function callback() {
		if ((isset($this->request->post['callbackPW'])) && ($this->request->post['callbackPW'] == $this->config->get('worldpay_password'))) {
			...
			if (isset($this->request->post['transStatus']) && $this->request->post['transStatus'] == 'Y') { 
				...
				$this->model_checkout_order->confirm($_SESSION['store_code'], $this->request->post['cartId'], $this->config->get('worldpay_order_status_id'));
				...
				$this->model_checkout_order->update($_SESSION['store_code'], $this->request->post['cartId'], $this->config->get('worldpay_order_status_id'), $message, FALSE);
