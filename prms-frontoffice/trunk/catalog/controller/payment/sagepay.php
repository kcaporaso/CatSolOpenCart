	...
	public function success() {
		if (isset($this->request->get['crypt'])) {
			...
			if ($data) {
				...
				$this->model_checkout_order->confirm($_SESSION['store_code'], $this->request->get['order_id'], $this->config->get('sagepay_order_status_id'));
				...
				$this->model_checkout_order->update($_SESSION['store_code'], $this->request->get['order_id'], $this->config->get('sagepay_order_status_id'), $message, FALSE);
