...
class Spreadsheet_Excel_Reader {
   ...
   // KMC
   var $_workbookVersion = 0;
   var $_worksheetVersion = 0;
   ...
   // KMC added versioning access.
   function setWorkbookVersion($v) {
     $this->_workbookVersion = $v;
   }

   public function getWorkbookVersion() {
      return $this->_workbookVersion;
   }

   // KMC added versioning access.
   function setWorksheetVersion($v) {
      $this->_worksheetVersion = $v;
   }

   public function getWorksheetVersion() {
      return $this->_worksheetVersion;
   }
	// --------------
	// END PUBLIC API
	...
	function _parse() {
      ...
      // KMC added versioning access.
      $this->setWorkbookVersion($version);
...
//						$bgcolor = ($bgi & 0x3f80) >> 7;
	...
	function _parsesheet($spos) {
      ...
      // KMC added versioning access.
      $this->setWorksheetVersion($version);
