...
//echo '<br/>looking for productset: -->' . $productset_code . '<--<br/>';    	        
       ...
       if ($result['errors']) {
         ...
         $our_productset_id = $productset_ids[0];
		   ...
		   $product_record_exists = $this->db->get_record('product', "product_id = '{$product['product_id']}' and productset_id = '{$our_productset_id}'");
           ...
           */
           ...
           if ($_SESSION['products_importer']['import_type']['selected'] == 'products_C') {
                 ...
                 */   
                 ...
                 $product_core['productset_id'] = $our_productset_id;
    		        ...
    		        if ($product_core['image_for_alt_main_thumb'] == 'NULL') unset($product_core['image_for_alt_main_thumb']);
    		        */
    		        $this->db->update('product', $product_core, $where_clause . " and productset_id='{$our_productset_id}'");      
