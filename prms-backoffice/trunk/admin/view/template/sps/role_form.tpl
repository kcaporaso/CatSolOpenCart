  ...
  <div id="tab_general" class="page">
    <table class="form">
      <tr>
        ...
        <td><input type="text" name="role_name" value="<?php echo $role_name; ?>" />
          <br />
          <?php if ($error_name) { ?>
      ...
      <tr>
        ...
        <td><div class="scrollbox">
            ...
            <div class="<?php echo $class; ?>">
              ...
              <input type="checkbox" name="permission[access][]" value="<?php echo $permission; ?>" checked="checked" /><?php echo $permission; ?>
              <?php } else { ?>
      ...
      <tr>
        ...
        <td><div class="scrollbox">
            ...
            <div class="<?php echo $class; ?>">
              ...
              <input type="checkbox" name="permission[modify][]" value="<?php echo $permission; ?>" checked="checked" /><?php echo $permission; ?>
              <?php } else { ?>
