  ...
  <div id="tab_general" class="page">
    <table class="form">
      <tr>
        ...
        <td><select name="events_position">
            <?php if ($events_position == 'homepage') { ?>
      ...
      <tr>
        ...
        <td><input type="text" name="events_sort_order" value="<?php echo $events_sort_order; ?>" size="1" /></td>
      </tr>
    </table>
  </div>
</form>
