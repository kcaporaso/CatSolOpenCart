    ...
    <td>Payment Method<br />
      <select name="filter_payment_method" style="margin-top: 4px;">
        ...
        <?php foreach ($payment_methods as $key=>$payment_method) { ?>
            <?php if ($payment_method == $filter_payment_method) { ?>
...
<table class="list">
  ...
  <tbody>
    ...
    <?php } ?>
    <tr>
      <td class="left">Report Totals</td>
      <td class="left"></td>
      <td class="right"><strong><?php echo $page_total_order_count; ?></strong></td>
      <td class="right"><strong><?php echo $page_total_order_total; ?></strong></td>
    </tr>
    <?php } else { ?>
    <tr class="even">
