    ...
    <table class="form">
      <tr>
        ...
        <td><input type="text" name="name" value="<?php echo $name; ?>" />
          ...
          <?php } ?>
          <span class="help">Note : do not "recycle" this Country by naming it something else. You may only correct for typos. Keep in mind that a Country may be referenced in old Orders etc. If you need a new Country please create a new one.</span>
        </td>
      </tr>
      <tr>
