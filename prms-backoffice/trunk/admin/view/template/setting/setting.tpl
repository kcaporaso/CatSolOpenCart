...
<div class="tabs"><a tab="#tab_shop"><?php echo $tab_shop; ?></a><a tab="#tab_local"><?php echo $tab_local; ?></a><a tab="#tab_option"><?php echo $tab_option; ?></a>
<?php if ($_SESSION['user_is_admin']): ?> 
<a tab="#tab_image"><?php echo $tab_image; ?></a>
<?php endif; ?>

<a tab="#tab_stats"><?php echo $tab_stats; ?></a><a tab="#tab_share"><?php echo $tab_share; ?></a><?php if ($_SESSION['modgode']): ?><a tab="#tab_mail">@ <?php echo $tab_mail; ?></a><a tab="#tab_server">@ <?php echo $tab_server; ?></a><?php endif; ?></div>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
  <div id="tab_shop" class="page">
    <table class="form">
      ...
      <tr>
        <td width="25%"><?php echo $entry_home_page; ?></td>
        <td><input type="text" name="config_home_page" value="<?php echo $config_home_page; ?>" />
          <br />
          <?php if (@$error_home_page) { ?>
          <span class="error"><?php echo $error_home_page; ?></span>
          <?php } ?></td>
      </tr>
      ...
      <tr>
        <td><span class="required">*</span> <?php echo $entry_email; ?><span class="help">Multiple addresses, separate by commas</span></td>
        <td><input type="text" name="config_email" value="<?php echo $config_email; ?>" size="80"/>
          <br />
          <?php if ($error_email) { ?>
  ...
  <div id="tab_local" class="page">
    <table class="form">
      ...
      <tr>
        <td>Minimum Purchase Amount:<span class="help">(e.g. 15.00)</span></td>
        <td><input type="text" name="config_min_purchase" value="<?php echo $config_min_purchase; ?>" disabled="disabled" />(Coming soon!)</td>
      </tr>
      <?php if ($_SESSION['modgode']): ?>
          <tr>
  ...
  <div id="tab_option" class="page">
    <table class="form">
      ...
      <tr>
        <td>Allow Nonstandard Products: <span class="help">Allow Customers to enter and purchase their own Products even if they are not in the system.</span></td>
        <td><?php if ($config_nonstandard_products) { ?>
          <input type="radio" name="config_nonstandard_products" value="1" checked="checked" />
          <?php echo $text_yes; ?>
          <input type="radio" name="config_nonstandard_products" value="0" />
          <?php echo $text_no; ?>
          <?php } else { ?>
          <input type="radio" name="config_nonstandard_products" value="1" />
          <?php echo $text_yes; ?>
          <input type="radio" name="config_nonstandard_products" value="0" checked="checked" />
          <?php echo $text_no; ?>
          <?php } ?></td>
      </tr>      
      <?php if ($_SESSION['modgode']): ?>
      ...
      <?php endif; ?>
      <!--tr>
        <td>Default "Out of Stock" status:</td>
...
<?php if ($_SESSION['user_is_admin']): ?>
  <div id="tab_image" class="page">
    <table class="form">
      ...
      <!-- TAKE OUT PER ANDREA tr>
        <td>Header nav menu background color:</td>
        <td>
        	<input class="color" type="text" name="config_navbackground_color" value="<?php echo $config_navbackground_color; ?>" size="6" />
        	(approximate; check Storefront for actual color)
		</td>
      </tr-->      
      <?php /* this appears to be not used anywhere ?>
      <tr>
...
<?php endif; ?>  
  ...
  <div id="tab_stats" class="page">
    <table class="form">
      <tr>
        <td width="33%">Google Analytics Tracking Code: <span class="help">Usually in the format "UA-XXXXX-X"</span></td>
        <td><input size="36" type="text" name="config_googleanalytics_code" value="<?php echo $config_googleanalytics_code; ?>" />
      </tr>    
    </table>
  </div>  
  
  <div id="tab_share" class="page">
    <table class="form">
      <tr>
        <td width="33%">Enable Facebook Share</td>
        <td><label><input type="radio" value="1" name="config_share_facebook" <?php if($config_share_facebook){echo 'checked="checked" ';}?>/> Yes</label>
        	<label><input type="radio" value="0" name="config_share_facebook" <?php if(!$config_share_facebook){echo 'checked="checked" ';}?>/> No</label>
        </td>
      </tr>    
      <tr>
        <td width="33%">Enable Twitter Share</td>
        <td><label><input type="radio" value="1" name="config_share_twitter" <?php if($config_share_twitter){echo 'checked="checked" ';}?>/> Yes</label>
        	<label><input type="radio" value="0" name="config_share_twitter" <?php if(!$config_share_twitter){echo 'checked="checked" ';}?>/> No</label>
        </td>
      </tr>    
    </table>
  </div>
...
$(document).ready(function() { 
	new AjaxUpload('#upload', {
		action: 'index.php?route=catalog/image/uploadStoreLogo',
		name: 'image',
		autoSubmit: true,
		responseType: 'json',
