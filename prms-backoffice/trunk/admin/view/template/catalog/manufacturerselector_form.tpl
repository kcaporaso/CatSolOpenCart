...
<?php endif; ?>
<form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="manufacturerselector_form">

    <table class="form" style="width:444px;" >
    	
      	<tr>
      		<td colspan="9">
      			<select multiple size="12" name="manufacturer_ids[]">
      				<option <?php echo (!$coupon_manufacturer_ids)? 'selected' : ''; ?> >[ no restriction ]</option>
      				<?php echo $manufacturer_dropdown_options; ?>
      			</select>
      		</td>
      	</tr>
        ...
        <tr>
        	<td colspan="9">
	        	...
	        	<div class="buttons"><a onclick="$('#manufacturerselector_form').submit();" class="button"><span class="button_left button_save"></span><span class="button_middle"><?php echo $button_save; ?></span><span class="button_right"></span></a></div>
