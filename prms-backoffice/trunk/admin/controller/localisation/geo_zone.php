...
class ControllerLocalisationGeoZone extends Controller { 
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
			...
			$this->model_localisation_geo_zone->addGeoZone($_SESSION['store_code'], $this->request->post);
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
			$this->model_localisation_geo_zone->editGeoZone($_SESSION['store_code'], $this->request->get['geo_zone_id'], $this->request->post);
	...
	public function delete() {
		...
		if ((isset($this->request->post['delete'])) && ($this->validateDelete())) {
			foreach ($this->request->post['delete'] as $geo_zone_id) {
				$this->model_localisation_geo_zone->deleteGeoZone($_SESSION['store_code'], $geo_zone_id);
			}
	...
	private function getList() {
		...
		$geo_zone_total = $this->model_localisation_geo_zone->getTotalGeoZones($_SESSION['store_code']);
		
		$this->data['geozone_continental_USA_not_created_yet'] = $this->model_localisation_geo_zone->geozone_continental_USA_not_created_yet($_SESSION['store_code']);
		
		$results = $this->model_localisation_geo_zone->getGeoZones($_SESSION['store_code'], $data);
	...
	private function getForm() {
		...
		if ((isset($this->request->get['geo_zone_id'])) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$geo_zone_info = $this->model_localisation_geo_zone->getGeoZone($_SESSION['store_code'], $this->request->get['geo_zone_id']);
		}
		...
		$this->data['countries'] = $this->model_store_country->getRecords($_SESSION['store_code'], null, null, null);
