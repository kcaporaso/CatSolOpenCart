...
class ControllerUserUser extends Controller {  
	...
	private function getForm() {
    	...
    	$this->data['membershiptier_dropdown'] = $this->model_user_membershiptier->getDropdownOptions($user_info['membershiptier_id'], false);
  	...
  	private function validateForm() {
    	...
    	if (($this->request->post['password']) || (!isset($this->request->get['user_id']))) {
      		if ((strlen(utf8_decode($this->request->post['password'])) < 4) || (strlen(utf8_decode($this->request->post['password'])) > 50)) {
