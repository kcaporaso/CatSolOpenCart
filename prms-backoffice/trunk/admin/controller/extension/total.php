...
class ControllerExtensionTotal extends Controller {
	public function index() {
		...
		$extensions = $this->model_setting_extension->getInstalled($_SESSION['store_code'], 'total');
	...
	public function install() {
		if (!$this->user->hasPermission('modify', 'extension/total')) {
			...
			$this->model_setting_extension->install($_SESSION['store_code'], 'total', $this->request->get['extension']);
	...
	public function uninstall() {
		if (!$this->user->hasPermission('modify', 'extension/total')) {
			...
			$this->model_setting_extension->uninstall($_SESSION['store_code'], 'total', $this->request->get['extension']);
