...
class ControllerExtensionModule extends Controller {
	public function index() {
		...
		$extensions = $this->model_setting_extension->getInstalled($_SESSION['store_code'], 'module');
	...
	public function install() {
		if (!$this->user->hasPermission('modify', 'extension/module')) {
			...
			$this->model_setting_extension->install($_SESSION['store_code'], 'module', $this->request->get['extension']);
	...
	public function uninstall() {
		if (!$this->user->hasPermission('modify', 'extension/module')) {
			...
			$this->model_setting_extension->uninstall($_SESSION['store_code'], 'module', $this->request->get['extension']);
