...
class ControllerExtensionPayment extends Controller {
	public function index() {
		...
		$extensions = $this->model_setting_extension->getInstalled($_SESSION['store_code'], 'payment');
		...
		if ($files) {
            ...
            if (!$this->user->isSPS() && ($extension == 'skip_payment' || $extension == 'sps_purchase_order')) { continue; } 
	...
	public function install() {
		if (!$this->user->hasPermission('modify', 'extension/payment')) {
			...
			$this->model_setting_extension->install($_SESSION['store_code'], 'payment', $this->request->get['extension']);
	...
	public function uninstall() {
		if (!$this->user->hasPermission('modify', 'extension/payment')) {
			...
			$this->model_setting_extension->uninstall($_SESSION['store_code'], 'payment', $this->request->get['extension']);
		
			$this->model_setting_setting->deleteSetting($this->request->get['extension'], $_SESSION['store_code']);
