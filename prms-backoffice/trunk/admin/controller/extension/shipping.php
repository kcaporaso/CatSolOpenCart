...
class ControllerExtensionShipping extends Controller {
	public function index() {
		...
		$extensions = $this->model_setting_extension->getInstalled($_SESSION['store_code'], 'shipping');
	...
	public function install() {
		if (!$this->user->hasPermission('modify', 'extension/shipping')) {
			...
			$this->model_setting_extension->install($_SESSION['store_code'], 'shipping', $this->request->get['extension']);
	...
	public function uninstall() {
		if (!$this->user->hasPermission('modify', 'extension/shipping')) {
			...
			$this->model_setting_extension->uninstall($_SESSION['store_code'], 'shipping', $this->request->get['extension']);
