	...
	private $error = array();
  	...
  	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
		    ...
		    if ($this->model_catalog_manufacturer->url_alias_already_in_use($this->request->post['keyword'])) {
  	...
  	public function update() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
		    ...
		    if ($this->model_catalog_manufacturer->url_alias_already_in_use($this->request->post['keyword'], $this->request->get['manufacturer_id'])) {
