...
class ControllerCatalogReview extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
			$this->model_catalog_review->addReview($_SESSION['store_code'], $this->request->post);
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
			$this->model_catalog_review->editReview($_SESSION['store_code'], $this->request->get['review_id'], $this->request->post);
	...
	public function delete() { 
		...
		if ((isset($this->request->post['delete'])) && ($this->validateDelete())) {
			foreach ($this->request->post['delete'] as $review_id) {
				$this->model_catalog_review->deleteReview($_SESSION['store_code'], $review_id);
			}
	...
	private function getList() {
		...
		$review_total = $this->model_catalog_review->getTotalReviews($_SESSION['store_code']);
	
		$results = $this->model_catalog_review->getReviews($_SESSION['store_code'], $data);
	...
	private function getForm() {
		...
		if ((isset($this->request->get['review_id'])) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$review_info = $this->model_catalog_review->getReview($_SESSION['store_code'], $this->request->get['review_id']);
		}
      ...
      // Was here causing failed loading.
		$this->load->model('store/product');
		$this->data['products'] = $this->model_store_product->getRecords($_SESSION['store_code'], array('excluded'=>'0'), $this->user->getID());


      // KMC try something simplier here.
		//$this->load->model('catalog/product');		
		//$this->data['products'] = array($this->model_catalog_product->getProduct($this->data['product_id']));
