...
$_['entry_home_page']        = 'Home Page: (www.domain.com)';
...
$_['entry_stock_checkout']   = 'Stock Checkout:<br /><span class="help">Allow customers to still check out if the products they are ordering are not in stock.</span>';
...
$_['entry_parse_time']       = 'Display Parse Time:<br /><span class="help">You need to be careful displaying parse time as it can interfere with image uploading, image captures and many more features.</span>';
...
$_['error_meta_description'] = 'Meta Tag Description must be less than 132 characters!';
